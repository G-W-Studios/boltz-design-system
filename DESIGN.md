...
| `{typography.heading-sm}` | 36–48px | Subhead |
...
- **Canvas temperature:** White page canvas with warm cream (Tierra-50 #FBFAF7) or neutral cool grey (#F0EFEC) section bands — never blue-tinted
...
> **Token source of truth:** CSS custom properties, Tailwind classes, and component implementations live in `packages/tokens/src/tailwind.cjs` and `packages/ui/src/components/`. Do not maintain parallel CSS here — the codebase is authoritative.
